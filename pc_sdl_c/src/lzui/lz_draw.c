...
//    printf("%d,", opa);
    ...
    //lhb
    lz_color5658_t col;
    col.color.rgb565 = color.full;
    col.alpha = 0xff-opa;
    lz_draw_frame( x,y, 1,1, col);
}
...
//    printf("%d,", opa);
    ...
    col.color.rgb565 = color.full;
    col.alpha = 0xff-opa;
    lz_draw_frame( cords_p->x1,cords_p->y1, cords_p->x2 - cords_p->x1 +1,cords_p->y2 - cords_p->y1 +1, col);
                           ...
                           lv_opa_t opa_scale)
{
    ...
    lv_point_t * pattern = malloc(pattern_size * sizeof(lv_point_t));
    lv_coord_t i = 0;
